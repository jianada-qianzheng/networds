...
public class TagCloud {
    ...
    private void updateAll() {
        ...
        for(int i=0;i<dataSet.size();i++){
            if(dataSet.get(i).getRemember()==1)
                remembered.add(dataSet.get(i).getWord());
        }
        ...
        for (int j = 0; j < max; j++) {
            ...
            if(rz3>-10){
                ...
                tagCloud.get(j).setColor(Color.BLACK);

                //tagCloud.get(j).getView().

                //todo
                ((TextView) tagCloud.get(j).getView()).setClickable(false);
            }else{


                ((TextView) tagCloud.get(j).getView()).setClickable(true);

               if(remembered.contains( ((TextView) tagCloud.get(j).getView()).getText() )  ){
                   tagCloud.get(j).setColor(Color.GREEN);

               }else {
                   tagCloud.get(j).setColor(Color.LTGRAY);
               }
            }

//            if(dataSet.size()>0) {
//                if (dataSet.get(j).remember == 1) {
//                    tagCloud.get(j).setColor(Color.GREEN);
//
//                } else if (dataSet.get(j).remember == 0){
//                    tagCloud.get(j).setColor(Color.WHITE);
//
//                }
//            }
