...
public class ScrollLayout extends FrameLayout {
    ...
    private static final int FLING_VELOCITY_SLOP = 80;//80
    ...
    private final GestureDetector.OnGestureListener gestureListener =
            new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                    ...
                    Log.i("scroll layout ","velocityX:"+velocityX+"velocityY:"+velocityY);

                   // if(Math.abs(velocityX*)<Math.abs(velocityY)) {

                        Log.i("scroll layout ","down");
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.ScrollLayout_allowHorizontalScroll))
            isAllowHorizontalScroll = true;//a.getBoolean(R.styleable.ScrollLayout_allowHorizontalScroll, true);//changed by networds
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        Log.i("ScrollLayout","onInterceptTouchEvent");
        if (!isEnable) {
            return false;
        }
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.i("ScrollLayout","onInterceptTouchEvent,down");
            ...
            case MotionEvent.ACTION_UP:
                Log.i("ScrollLayout","onInterceptTouchEvent,move");

            case MotionEvent.ACTION_CANCEL:
                Log.i("ScrollLayout","onInterceptTouchEvent,cancel");
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(deltaY) < 2*Math.abs(deltaX)) {//changed by networds
                    Log.i("ScrollLayout","judge x ");
                    // horizontal event
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Log.i("ScrollLayout","onTouchEvent");
        if (!isCurrentPointerIntercepted) {
            return false;
        }
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.i("ScrollLayout","onTouchEvent,down");

                lastY = event.getY();

                return true;
            case MotionEvent.ACTION_MOVE:
                Log.i("ScrollLayout","onTouchEvent,move");
                ...
                return true;
            case MotionEvent.ACTION_UP:
                Log.i("ScrollLayout","onTouchEvent,up");

            case MotionEvent.ACTION_CANCEL:
                Log.i("ScrollLayout","onTouchEvent,cancel");
